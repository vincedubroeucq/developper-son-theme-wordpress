...
<form role="search" method="get" class="search-form flex flex-wrap" action="<?php echo esc_url( home_url() ); ?>">
    <label>
        <span class="screen-reader-text"><?php esc_html_e( 'Search&nbsp;:', 'voyager' ); ?></span>
        <input type="search" class="search-field" placeholder="<?php esc_attr_e( 'Cheap trip to the Moon', 'voyager' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s">
    </label>
