...
function voyager_scripts() {
    ...
    wp_enqueue_style( 'voyager-style', get_theme_file_uri( 'style' . $suffix . '.css' ), array(), $version );
    wp_enqueue_script( 'voyager-navigation', get_template_directory_uri() . '/js/navigation.' . $suffix . 'js', array(), $version, false );
...
function voyager_setup(){
    ...
    // Support for WordPress native features
